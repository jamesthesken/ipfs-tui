...
func StartTea() {
	...
	m := MainModel{list: l, filetree: filetreeModel}
...
func generateSwarmMsg(m MainModel) func() tea.Msg {
	return func() tea.Msg {
...
// doTick()
func (m MainModel) getSwarmPeers() tea.Cmd {
